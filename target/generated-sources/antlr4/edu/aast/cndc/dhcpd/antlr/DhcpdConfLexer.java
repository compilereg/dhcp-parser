...
public class DhcpdConfLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INCLUDE", "SUBNET", "POOL", "HOST", "GROUP", "SHARED_NETWORK", "CLASS", 
			"SUBCLASS", "ZONE", "KEY", "LBRACE", "RBRACE", "SEMI", "COMMA", "COLON", 
			"SLASH", "OP", "DASH_LINE", "STRING", "IPV4", "NUMBER", "IDENT", "MAC", 
			"LINE_COMMENT", "BLOCK_COMMENT", "WS", "DIGIT", "HEX"
		};
	}
	...
	public DhcpdConfLexer(CharStream input) {
		super(input);
